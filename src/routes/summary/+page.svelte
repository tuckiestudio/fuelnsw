<script lang="ts">
	...
	import { FUEL_OPTIONS, FUEL_LABELS, FUEL_COLORS } from '$lib/utils/fuel-types';
	import type { DryStation, OfflineStation, FuelTypeAvailability, AvailabilityTrendPoint } from '$lib/api/types';
